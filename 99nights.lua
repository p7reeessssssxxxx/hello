...
local Window = Rayfield:CreateWindow({
    Name = "Yapppppp",
    Icon = 0, 
    LoadingTitle = "99 nights keysystem (n.exc)",
    ...
    KeySettings = {
       ...
       Key = {"99nightskey"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
    }
 })

 local Tab = Window:CreateTab("kill all - 99 nights", 4483362458) -- Title, Image
