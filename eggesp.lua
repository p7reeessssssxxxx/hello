...
local Window = Rayfield:CreateWindow({
    Name = "Yapppppp",
    Icon = 0, 
    LoadingTitle = "grow a garden keysystem",
    LoadingSubtitle = "autofarm GAG",
    Theme = "Default", 
    ...
    KeySettings = {
       ...
       Key = {"Growagardenkey"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
    }
 })

 local Tab = Window:CreateTab("Autofarm - Grow a garden", 4483362458) -- Title, Image
 ...
 local Button = Tab:CreateButton({
    ...
    Callback = function()
             loadstring(game:HttpGet('https://raw.githubusercontent.com/p7reeessssssxxxx/hello/refs/heads/main/eggespgagscripty.lua'))()
    end,
 })
