...
(getgenv()).Load = function()
	...
	if readfile and writefile and isfile and isfolder then
		...
		if not isfolder("Chaos Hub New") then

			makefolder("Chaos Hub New");

		end;

		if not isfolder("Blox Fruits/") then

			makefolder("Blox Fruits/");

		end;

		if not isfile(("Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json")) then

			writefile("Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(_G.Settings));

		else

			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveSetting = function()
	...
	if readfile and writefile and isfile and isfolder then
		...
		if not isfile(("Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
	...
	Buttons = {

		{
			...
			Callback = function()
				...
				setclipboard("https://discord.gg/pcabxYSBSJ");
