...
local Window = Rayfield:CreateWindow({
    Name = "Yapppppp",
    Icon = 0, 
    LoadingTitle = "deadrails autofarm keysystem",
    LoadingSubtitle = "autofarm bounds",
    Theme = "Default", 
    ...
    KeySettings = {
       ...
       Key = {"keyapple1234"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
    }
 })

 local Tab = Window:CreateTab("Autofarm - deadrails", 4483362458) -- Title, Image
